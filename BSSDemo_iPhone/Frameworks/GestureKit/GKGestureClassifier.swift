...
class GKPredefinedGestureClassifier {
    static var UpDownLeftRight : GKGestureClassifier {
        get{
            return GKGestureClassifier(gesturePatterns: [GKPredefinedGesturePattern.Up,GKPredefinedGesturePattern.Down,GKPredefinedGesturePattern.Left,GKPredefinedGesturePattern.Right], searchRange: 5, thresholds: [650.0,650.0,650.0,500.0], deltaThreshold: -100.0, costsQueueLength: 6)
        }
    }
}
