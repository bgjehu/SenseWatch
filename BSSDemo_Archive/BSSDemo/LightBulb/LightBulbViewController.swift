...
class LightBulbViewController: UIViewController {
    ...
    func registerNotifications() {
        ...
        GKPredefinedGesture.Left.registerNotification(self, selector: "decreaseLightColorHue")
        GKPredefinedGesture.Right.registerNotification(self, selector: "increaseLightColorHue")
